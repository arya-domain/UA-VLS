...
from utils.model import UA_VLS
...
from engine.loss import SEU_Loss

class UA_VLSWrapper(pl.LightningModule):

    def __init__(self, args):
        
        super(UA_VLSWrapper, self).__init__()
        
        self.model = UA_VLS(args.bert_type, args.vision_type, args.project_dim)
        self.lr = args.lr
        self.history = {}
        
        self.loss_fn = DiceCELoss()
        # self.loss_fn = SEU_Loss()
